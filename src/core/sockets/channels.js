/**
 * Real-time Event Channel Factory
...
export default function (app) {
  ...
  app.on('login', (authResult, { connection }) => {
    ...
    if (connection) {
      /**
       * Obtain the logged in user from the
       * connection const user = connection.user;
       **/
  ...
  app.publish((data, hook) => { // eslint-disable-line no-unused-vars
     ...
     */
    console.log('Publishing all events to all authenticated users. See `channels.js` ' +
      'and https://docs.feathersjs.com/api/channels.html for more information.') // eslint-disable-line
