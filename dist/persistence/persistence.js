...
class Persistence {
  ...
  constructor(options, db = null) {
    _assert2.default.equal(typeof options.name, 'string', 'persistence: options.name must be valid collection name');
  ...
  async find(query, params) {
    ...
    return await Promise.resolve([{ id: 1, text: `A new message with ID: 1!` }, { id: 2, text: `A new message with ID: 1!` }]);
  }
